...
if (isset($_GET['delete'])) {
    ...
    $conn->query("DELETE FROM golden_triangle WHERE id = $id");
    header('Location: golden-triangle.php');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
        $upload_dir = '../assets/img/golden-triangle/';
        ...
        if(move_uploaded_file($_FILES['image']['tmp_name'], $target_file)) {
            $image = 'assets/img/golden-triangle/' . $new_filename;
            // Delete old image
    ...
    $gallery_images = handleGalleryUpload($_FILES, 'golden_triangle', $id);
    ...
    if ($id > 0) {
        // Update
        $sql = "UPDATE golden_triangle SET 
        ...
        // Insert - build columns and values
        ...
        $conn->query("INSERT INTO golden_triangle ($cols) VALUES ($vals)");
    }
    header('Location: golden-triangle.php');
    exit;
}

$packages = $conn->query("SELECT * FROM golden_triangle ORDER BY id DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Golden Triangle Tours</title>
...
<body>
    ...
    <main id="main-content">
        <h1 class="page-title">Golden Triangle Tours</h1>
            ...
            <div class="modal-content">
                <form method="POST" enctype="multipart/form-data">
                    <div class="modal-header">
                        <h5 class="modal-title">Golden Triangle Tour Form</h5>
