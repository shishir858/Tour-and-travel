...
<body>
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    // File upload path
                    $target_dir = "assets/img/himachal-tour-images/";
                    ...
                    $query = "INSERT INTO himachal_packages (
    ...
    '$itinery_heading_17', '$itinery_description_17'
            ...
            <div class="container-fluid">
                ...
                <?php
include('connection.php');
$result = mysqli_query($conn, "SELECT * FROM himachal_packages ORDER BY id DESC");
?>
    ...
    <table class="table table-bordered table-hover">
        ...
        <?php while ($row = mysqli_fetch_assoc($result)) : ?>
            <tr>
                ...
                <td>
                    <a href="edit-himachal-package.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning mb-1">Edit</a>
                    <a href="delete-himachal_package.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this entry?');">Delete</a>
                </td>
            </tr>
        <?php endwhile; ?>
        </tbody>
