...
if (isset($_GET['delete_id'])) {
    ...
    $query = "SELECT package_image FROM other_services WHERE id = $package_id";
    ...
    $deleteQuery = "DELETE FROM other_services WHERE id = $package_id";
    ...
    echo "<script>window.location.href='add-other-services.php?status=$status&message=$message';</script>";
    exit;
}
?>
...
<script>
    ...
    if (status && message) {
        ...
        window.location.href = 'add-other-services.php'; // Redirect if no status/message found
    }
</script>
