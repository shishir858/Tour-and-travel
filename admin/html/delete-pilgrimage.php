...
$result = mysqli_query($conn, "SELECT image FROM pilgrimage_package WHERE id = $id");
...
// Delete the package
$query = "DELETE FROM pilgrimage_package WHERE id = $id";
if (mysqli_query($conn, $query)) {
    echo "<script>alert('✅ Package deleted successfully.'); window.location.href='add-pilgrimage.php';</script>";
} else {
