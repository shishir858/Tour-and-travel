...
<body>
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $query = "INSERT INTO tajmahal_tours (
    ...
    '$itinery_heading_17', '$itinery_description_17'
            ...
            <div class="container-fluid">
                ...
                <?php
include('connection.php');
$result = mysqli_query($conn, "SELECT * FROM tajmahal_tours ORDER BY id DESC");
?>
    ...
    <table class="table table-bordered table-hover">
        ...
        <?php while ($row = mysqli_fetch_assoc($result)) : ?>
            <tr>
                ...
                <td>
                    <a href="edit-tajmahal.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning mb-1">Edit</a>
