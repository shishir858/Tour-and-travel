...
$result = mysqli_query($conn, "SELECT image FROM golden_triangle WHERE id = $id");
...
// Delete the package
$query = "DELETE FROM golden_triangle WHERE id = $id";
if (mysqli_query($conn, $query)) {
    echo "<script>alert('✅ Package deleted successfully.'); window.location.href='add-golden-triangle.php';</script>";
} else {
