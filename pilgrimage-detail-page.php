...
<?php
$id = $_GET['id'];
$sql = "SELECT * FROM pilgrimage_package WHERE id = $id";
...
<!-- Modern Hero Section (matching Golden Triangle style) -->
  ...
  <div class="container h-100 position-relative">
    <div class="row h-100 align-items-center">
      <div class="col-lg-8 col-md-10 col-12 mx-auto text-center text-white" style="z-index:2;">
        ...
        <p class="lead mb-4" style="text-shadow:0 2px 8px rgba(0,0,0,0.3)">Explore the Pilgrimage Tours with us.</p>
...
<style>
/* Removed empty .package-info-box rule and fixed .quick-info-bar block */
.quick-info-bar {
...
.info-card-glass {
            ...
            <div class="sticky-top" style="top: 100px;">
              <div class="card shadow-sm mb-4">
                ...
                <ul class="list-group list-group-flush">
                  <?php
                  $sql = "SELECT id, title, image, duration FROM pilgrimage_package WHERE id != $id ORDER BY RAND() LIMIT 4";
                  $result = $conn->query($sql);
                  while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<div>';
                    echo '<a href="pilgrimage-detail-page.php?id=' . $row['id'] . '" class="fw-bold text-decoration-none text-dark">' . htmlspecialchars($row['title']) . '</a><br>';
    ...
    <!-- Carousel of Other Pilgrimage Packages -->
    <section class="py-5 bg-light">
      <div class="container">
        <h2 class="mb-4 text-center">Other Pilgrimage Packages</h2>
        <div class="owl-carousel owl-theme">
          <?php
          $sql = "SELECT id, title, image, duration, persons, places_covered, description FROM pilgrimage_package WHERE id != $id ORDER BY RAND() LIMIT 8";
          $result = $conn->query($sql);
          while ($row = $result->fetch_assoc()) {
            ...
            echo '<a href="pilgrimage-detail-page.php?id=' . $row['id'] . '" class="btn btn-outline-primary btn-sm mt-2">View Details</a>';
            echo '</div>';
            echo '</div>';
            echo '</div>';
          }
