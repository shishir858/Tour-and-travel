...
<?php
$id = $_GET['id'];
$sql = "SELECT * FROM golden_triangle WHERE id = $id";
$result = $conn->query($sql);
$goldentrianglerow = $result->fetch_assoc();
?>
<!-- All CSS is loaded from header.php -->
<script src="whatsapp-form.js"></script>
<!-- Separate JS for Itinerary accordion -->
<script src="assets/js/itinerary-accordion.js"></script>
  ...
  <div class="container h-100 position-relative">
    <div class="row h-100 align-items-center">
      <div class="col-lg-8 col-md-10 col-12 mx-auto text-center text-white" style="z-index:2;">
        ...
        <p class="lead mb-4" style="text-shadow:0 2px 8px rgba(0,0,0,0.3)">Explore the Golden Triangle with us.</p>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-8 col-12 mb-4 mb-lg-0">
        <div class="card shadow-sm border-0 mb-4">
          ...
          <div class="card-body">
            ...
            <div class="d-flex flex-wrap mb-3">
              <div class="me-4 mb-2"><i class="fa fa-clock text-dark me-1"></i> <?php echo htmlspecialchars($goldentrianglerow['duration']); ?></div>
              <div class="me-4 mb-2"><i class="fa fa-user text-dark me-1"></i> <?php echo htmlspecialchars($goldentrianglerow['persons']); ?></div>
              <div class="mb-2"><i class="fa fa-map-marker-alt text-dark me-1"></i> <?php echo htmlspecialchars($goldentrianglerow['places_covered']); ?></div>
            </div>
        ...
        <div class="card shadow-sm border-0 mb-4">
          <div class="card-body">
            <h4 class="mb-4 text-dark">Itinerary</h4>
        ...
        <!-- Included and Excluded (Commented Out)
        <div class="card shadow-sm border-0 mb-4">
          <div class="card-body">
            <h5 class="mb-3 text-dark">Included and Excluded</h5>
            <div class="row">
              <div class="col-md-6">
        ...
        <div class="sticky-top" style="top: 100px;">
          <div class="card shadow-sm mb-4">
            ...
            <ul class="list-group list-group-flush">
              <?php
              $sql = "SELECT id, title, image, duration FROM golden_triangle WHERE id != $id ORDER BY RAND() LIMIT 4";
              $result = $conn->query($sql);
              while ($row = $result->fetch_assoc()) {
                ...
                echo '<div>';
                echo '<a href="golden-triangle-detail-page.php?id=' . $row['id'] . '" class="fw-bold text-decoration-none text-dark">' . htmlspecialchars($row['title']) . '</a><br>';
...
<!-- Carousel of Other Golden Triangle Packages -->
<section class="py-5 bg-light">
  <div class="container">
    <h2 class="mb-4 text-center">Other Golden Triangle Packages</h2>
    <div class="owl-carousel owl-theme">
      <?php
      $sql = "SELECT id, title, image, duration, persons, places_covered, description FROM golden_triangle WHERE id != $id ORDER BY RAND() LIMIT 8";
      $result = $conn->query($sql);
      while ($row = $result->fetch_assoc()) {
        // $desc_words and $desc_limited removed; no description needed
        echo '<div class="item">';
        ...
        echo '<h5 class="">' . htmlspecialchars($row['title']) . '</h5>';
        ...
        // Description intentionally omitted for cleaner card UI
        echo '<a href="golden-triangle-detail-page.php?id=' . $row['id'] . '" class="btn btn-outline-primary btn-sm mt-2">View Details</a>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
      }
